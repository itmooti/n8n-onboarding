...
export const STEP_VIDEOS: Record<number, { src: string; title: string; duration: string }> = {
  ...
  7: { src: `/videos/step08-openrouter.mp4${CACHE_BUST}`, title: 'What is OpenRouter?', duration: '0:08' },
  8: { src: `/videos/step07-credentials.mp4${CACHE_BUST}`, title: 'Credential Setup', duration: '0:08' },
