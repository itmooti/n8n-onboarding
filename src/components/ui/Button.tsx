...
export function Button({
  ...
  const variants: Record<string, string> = {
    primary: `px-6 sm:px-8 py-3 sm:py-3.5 text-[13px] sm:text-[14px] text-white border-none ${
      disabled
        ? 'bg-gray-300 cursor-not-allowed'
        : 'bg-gradient-to-br from-accent to-accent-orange hover:shadow-[0_8px_25px_rgba(233,72,77,0.25)] hover:-translate-y-0.5'
    }`,
    ghost:
      'px-6 sm:px-8 py-3 sm:py-3.5 text-[13px] sm:text-[14px] text-navy bg-transparent border-2 border-gray-border hover:border-accent/20 hover:bg-accent/[0.03]',
    dark: `px-6 sm:px-8 py-3 sm:py-3.5 text-[13px] sm:text-[14px] text-white border-none bg-navy ${
